...
{
    [Serializable]
    public class NativeOverridableList<T> : IList<T>, ICollection<T>, IEnumerable<T>, IEnumerable, IList, ICollection
    {
        ...
        // 
        public NativeOverridableList(int capacity)
        {
            if (capacity < 0)
        ...
        // given collection.
        // 
        public NativeOverridableList(IEnumerable<T> collection)
        {
            if (collection == null)
